...
//    private var chineseMonth:Int = 0 // start from 1, negative int represents LeapMonth
//    private var chineseDate:Int = 0
//    private var sectionalTerm:Int = 0
//    private var principleTerm:Int = 0
//
//    private var areChineseFieldsComputed:Boolean = true // is lunar date be calculated accurately
//    private var areSolarTermsComputed:Boolean= true
//    private var lastSetChinese:Boolean = true
//
//    public constructor():super() {
//    }
//
//    public constructor( date: Date):super() {
//        super.setTime(date)
//    }
//
//    public constructor( c: Calendar):super(c.getTime()) {
//    }
//
//    public constructor(year:Int, month:Int, day:Int):super(year, month, day) {
//    }
//
//    public constructor(isChinese:Boolean, year:Int, month:Int, day:Int) {
//        if (isChinese) {
